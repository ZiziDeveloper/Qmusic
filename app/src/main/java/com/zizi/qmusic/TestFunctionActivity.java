    ...
    private void initWave() {
        ...
        scoreBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TestFunctionActivity.this,sim+"",Toast.LENGTH_LONG).show();
            }
        });
        ...
        mLoadSoundFileThread = new Thread() {
            public void run() {
                ...
                if (mLoadingKeepGoing) {
                    ...
                    TestFunctionActivity.this.runOnUiThread(runnable);
                }
            }
        };
...
//        MainActivityPermissionsDispatcher.initAudioWithCheck(this);
    ...
    void showRecordDenied(){
        Toast.makeText(TestFunctionActivity.this,"拒绝录音权限将无法进行挑战",Toast.LENGTH_LONG).show();
    }
